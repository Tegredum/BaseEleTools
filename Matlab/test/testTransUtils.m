...
psi = 0.0;
disp(['正北方向计算结果：',...
    num2str(TransUtils_teg.velDir_2_velVec(...
        'V', V,...
        'theta', theta,...
        'psi', psi)')])
% case 2：垂直向上
...
disp(['弹道倾角与偏角均为 45 度计算结果：',...
    num2str(TransUtils_teg.velDir_2_velVec(...
        ...
        'theta', theta,...
        'psi', psi)')])
%% 测试 par_velVec_par_V 方法
% case 1：方向角全为 0
V = 1.0;
V_delta = 1e-3;
theta = 0.0;
psi = 0.0;
velVec_original = TransUtils_teg.velDir_2_velVec(...
    'V', V,...
    'theta', theta,...
    'psi', psi);
velVec_with_delta = TransUtils_teg.velDir_2_velVec(...
    'V', V + V_delta,...
    'theta', theta,...
    'psi', psi);
disp(['case 1：解析解与数值解偏差：',...
    num2str((TransUtils_teg.par_velVec_par_V(...
        'theta', theta,...
        'psi', psi)...
...
velVec_with_delta = TransUtils_teg.velDir_2_velVec(...
    ...
    'psi', psi);
disp(['case 1：解析解与数值解偏差：',...
    num2str((TransUtils_teg.par_velVec_par_theta(...
        'V', V,...
        'theta', theta,...
        'psi', psi)...
...
velVec_with_delta = TransUtils_teg.velDir_2_velVec(...
    ...
    'psi', psi + psi_delta);
disp(['case 1：解析解与数值解偏差：',...
    num2str((TransUtils_teg.par_velVec_par_psi(...
        'V', V,...
        'theta', theta,...
        'psi', psi)...
